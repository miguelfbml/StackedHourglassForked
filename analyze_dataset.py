            ...
            if 'data' in npz_data:
                ...
                if isinstance(data, dict) and 'imgname' in data:
                    ...
                    for i in range(min(10, len(imgnames))):
                        ...
                        # Try different root paths and path combinations
                        for root in mpi_roots:
                            possible_paths = [
                                os.path.join(root, imgname),
                                os.path.join(root, imgname.lstrip('/')),
                            ]
                            
                            # If imgname doesn't have imageSequence, try adding it
