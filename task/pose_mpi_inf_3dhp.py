...
__config__ = {
    'data_provider': 'data.MPI_INF_3DHP.dp',
    'network': 'models.posenet.PoseNet',
    'data_root': 'data/motion3d',  # Path to the motion3d directory with MPI-INF-3DHP data
    'inference': {
        'nstack': 8,
        'inp_dim': 256,
        ...
        'increase': 0,
        'keys': ['imgs'],
        'num_eval': 1000,  # Adjust based on your validation set size
        'train_num_eval': 300,
    },
