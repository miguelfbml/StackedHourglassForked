...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return dummy_img.astype(np.float32), dummy_heatmaps.astype(np.float32)
    ...
    def loadImage(self, data_tuple):
        ...
        if img is None:
            ...
            img = np.random.randint(0, 256, (self.input_res, self.input_res, 3), dtype=np.uint8)
        ...
        keypoints[0, :, 2] = pose_2d[:, 2]  # Use confidence from original data
